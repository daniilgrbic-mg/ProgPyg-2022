...
def crtaj():
    ...
    # naslov prozora prikazuje poene
    ...
    for y in range(5, VISINA, 10):
        # crtamo isprekidanu liniju u centur ekrana
        pygame.draw.line(prozor, Color("black"), (SIRINA//2, y), (SIRINA//2, y+5), 1)
